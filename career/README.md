...
- 良記事:[約 4 割の採用担当者が「生成 AI でエンジニアに求められるスキルが変化した」](https://monoist.itmedia.co.jp/mn/articles/2502/21/news112.html)
  ...
  - 生成 AI の出現により以前ほど重要でなくなったと感じるスキル
    ...
    - 予算管理スキル
    - プロジェクト管理スキル
- [世はまさに大AI時代！「仕事はどうなるのか」不安な人に今やってほしい事](https://qiita.com/zazen_inu/items/9920bea2e15ecaaf1131)
  - AIエージェントの進化
    - **自律的行動**: 従来の生成AIから、目標に基づいて計画を立て、情報を収集し、タスクを持続的に実行するエージェントへと進化しています。
  ...
  - 新たな視点
    - **人間らしい仕事へのシフト**: 単調な業務はAIに任せ、人間は創造性や専門的判断に集中することが期待されます。
    - **研究の効率化**: AIと人間の協働が新たな発見を加速させる可能性があります。
    - **ビジネスリサーチの民主化**: 自律的な情報収集により、データ駆動型の意思決定が容易に。
  - 課題と未来へのステップ
    - **倫理・法的課題**: AIの判断の透明性や責任の所在が問題視されています。
