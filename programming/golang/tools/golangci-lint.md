...
## [vscode](https://golangci-lint.run/welcome/integrations/#go-for-visual-studio-code)
...
[github:golangci-lint/.golangci.yml 参考](https://github.com/golangci/golangci-lint/blob/master/.golangci.yml)
